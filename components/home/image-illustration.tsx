...
const ImageIllustration = () => {
    return (
        <div className="relative mx-auto w-full max-w-105 sm:max-w-120 lg:mr-0 lg:ml-auto lg:max-w-140">
            ...
            <div className="absolute -bottom-6 -left-6 size-32 rounded-[40px] bg-iris-400/20 sm:-bottom-10 sm:-left-16 sm:size-40 max-w-48 max-h-45 lg:-bottom-14 lg:-left-32" />
            <div className="absolute -bottom-8 -left-4 size-28 rounded-[40px] bg-gold-400/25 sm:-bottom-12 sm:-left-8 sm:size-36 max-h-40.5 lg:-bottom-18 lg:-left-12" />
